        ...
        <div className='flex items-center justify-between h-full'>
          ...
          <div className='hidden md:flex items-center gap-2'>
            ...
            <div className='relative' ref={dropdownRef}>
              ...
              {/* User Dropdown */}
              {isUserMenuOpen && (
                <div className="absolute right-0 mt-2 w-56 bg-[#0d0d22]/95 border border-white/5 rounded-xl shadow-2xl shadow-black/40 py-1.5 z-[100] overflow-hidden backdrop-blur-xl animate-fade-in"
                ...
                >
                  ...
                  <div className="py-1">
                    ...
                    <DropdownItem
                      ...
                      onClick={() => { setIsUserMenuOpen(false); navigate('/statistics'); }}
                    >
                      Statistics
                    </DropdownItem>
                  </div>
